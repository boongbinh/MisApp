...
class BangchiphitranapRow {
  ...
  BangchiphitranapRow({
    ...
    required this.tongTongchiphiDaumonhon,
    required this.donGiaXe,
    required this.donGiaGio,
  });

  factory BangchiphitranapRow.fromMap(Map<String, dynamic> map) {
...
// ====== CONTROLLER ======
class BangchiphitranapController extends GetxController {
  final rows = <BangchiphitranapRow>[].obs;
  ...
  void loadData(List<Map<String, dynamic>> data) {
    rows.assignAll(data.map((e) => BangchiphitranapRow.fromMap(e)).toList());
  }
...
// ====== WIDGET CHÍNH ======
class BangchiphitranapCard extends StatelessWidget {
  final List<Map<String, dynamic>> data;
  final String title;

  const BangchiphitranapCard({
    super.key,
    required this.data,
    this.title = 'BẢNG CHI PHÍ TRA NẠP',
  });

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(BangchiphitranapController())..loadData(data);
...
// ====== HÀM XÂY DỰNG DEFS ======
List<_ColDef> _buildDefs(BangchiphitranapController c) {
  final defs = <_ColDef>[];
...
double _getTotalFlex(BangchiphitranapController c) {
  double total = 0;
...
class _TableHeader extends StatelessWidget {
  ...
  final BangchiphitranapController controller;
...
class _RowWidget extends StatelessWidget {
  ...
  Widget _cell(String key, BangchiphitranapRow row) {
