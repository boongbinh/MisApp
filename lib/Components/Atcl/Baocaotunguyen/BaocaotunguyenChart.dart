...
class BaocaotunguyenChart extends StatelessWidget {
  const BaocaotunguyenChart({
    super.key,
    required this.dataList,
    this.title = 'BÁO CÁO TỔNG HỢP',
    this.strokeWidth = 70,
    this.showPercents = true,
  });

  final List<BaocaotunguyenData> dataList;
  final String title;
