// components/Atcl/Mohinhshell/mohinhshell_chart.dart
...
class MohinhshellChart extends StatelessWidget {
  const MohinhshellChart({
    super.key,
    required this.dataList,
    this.title = 'MÔ HÌNH SHELL',
    this.strokeWidth = 70,
    this.showPercents = true,
  });

  final List<MohinhshellData> dataList;
  final String title;
