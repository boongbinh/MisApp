...
class TheodoiXNTRow {
  ...
  factory TheodoiXNTRow.fromMap(Map<String, dynamic> map) {
    ...
    return TheodoiXNTRow(
      ...
      Sanluongngay: map['Sanluongngay']?.toString() ?? '',
...
class TheodoiXNTController extends GetxController {
  ...
  final showSanluongngay = true.obs;
...
class TheodoiXNT_SBCard extends StatelessWidget {
  final List<Map<String, dynamic>> data;
  final String title;

  const TheodoiXNT_SBCard({
    super.key,
    required this.data,
    this.title = 'THEO DÕI XNT KHO CẢNG - THEO SÂN BAY',
  });
...
List<_ColDef> _buildDefs(TheodoiXNTController c) {
  final configs = [
    ...
    // Khách hàng xuất
    ('showSanluongngay', 'Sanluongngay', 'SẢN LƯỢNG NGÀY', 1.2, Color(0xFFF4D9E8)),
  ];
  final showMap = {
    ...
    'showSanluongngay': c.showSanluongngay.value,
  };
...
double _getTotalFlex(TheodoiXNTController c) {
  ...
  if (c.showSanluongngay.value) total += 0.83;
                    ...
                    Expanded(
                      child: OutlinedButton(
                        onPressed: () {
                          ...
                          controller.showSanluongngay.value = true;
