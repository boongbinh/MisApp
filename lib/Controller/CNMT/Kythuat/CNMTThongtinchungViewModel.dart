...
class CNMTThongtinchungViewModel extends GetxController {
  // ====== Loading / Error ======
  ...
  void applyData(Map<String, dynamic> data) {
    ...
    print('Length: ${bangChiphi.length}');
  for (var item in bangChiphi) {
    print('ma_dv: ${item['ma_dv']}, TONG_CP_TH_thang: ${item['TONG_CP_TH_thang']}');
  }
  }
