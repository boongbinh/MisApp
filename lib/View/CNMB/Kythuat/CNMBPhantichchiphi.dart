...
class CNMBPhantichchiphi extends GetView<CNMBPhantichchiphiViewModel> {
  const CNMBPhantichchiphi({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Phân tích chi phí - CNMB'),
        centerTitle: true,
        elevation: 0,
...
class _DateRangeCard extends StatelessWidget {
  ...
  final CNMBPhantichchiphiViewModel vm;
...
class _FilterSheet extends StatefulWidget {
  static Future<void> open(BuildContext context, CNMBPhantichchiphiViewModel vm) async {
