...
List<_ColDef> _buildColDefs(DonghoDetailCNKVViewModel vm) {
  return [
...
class DonghoDetailCNKV extends GetView<DonghoDetailCNKVViewModel> {
  const DonghoDetailCNKV({super.key});
                ...
                children: [
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          GetBuilder<DonghoDetailCNKVViewModel>(
                            id: 'header',
...
class _SearchBar extends StatelessWidget {
  ...
  final DonghoDetailCNKVViewModel vm;
