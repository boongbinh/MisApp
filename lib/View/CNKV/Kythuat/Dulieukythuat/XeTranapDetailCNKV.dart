...
List<_ColDef> _buildColDefs(XeTranapDetailCNKVViewModel vm) {
  return [
...
class XeTranapDetailCNKV extends GetView<XeTranapDetailCNKVViewModel> {
  const XeTranapDetailCNKV({super.key});
