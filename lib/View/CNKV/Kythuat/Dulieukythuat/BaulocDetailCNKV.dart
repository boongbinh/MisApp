...
List<_ColDef> _buildColDefs(BaulocDetailCNKVViewModel vm) {
  return [
...
class BaulocDetailCNKV extends GetView<BaulocDetailCNKVViewModel> {
  const BaulocDetailCNKV({super.key});
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          GetBuilder<BaulocDetailCNKVViewModel>(
