...
List<_ColDef> _buildColDefs(BechuaDetailCNKVViewModel vm) {
  return [
...
class BechuaDetailCNKV extends GetView<BechuaDetailCNKVViewModel> {
  const BechuaDetailCNKV({super.key});
...
class _SearchBar extends StatelessWidget {
  ...
  final BechuaDetailCNKVViewModel vm;
