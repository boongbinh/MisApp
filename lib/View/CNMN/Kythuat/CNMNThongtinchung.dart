...
class CNMNThongtinchung extends GetView<CNMNThongtinchungViewModel> {
  const CNMNThongtinchung({super.key});
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Thông tin chung - CNMN'),
          centerTitle: true,
          elevation: 0,
...
class _SearchAndFilterBar extends StatelessWidget {
  ...
  final CNMNThongtinchungViewModel vm;
...
class _FilterSheet extends StatefulWidget {
  static Future<void> open(BuildContext context, CNMNThongtinchungViewModel vm) async {
