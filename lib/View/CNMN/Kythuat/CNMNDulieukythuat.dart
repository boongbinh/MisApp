...
class CNMNDulieukythuat extends GetView<CNMNDulieukythuatViewModel> {
  const CNMNDulieukythuat({super.key});
...
// ====== STAT CARD (Đơn giản chỉ có icon + value + chevron) ======
