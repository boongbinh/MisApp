...
class CNMNBaocaokhaithacngay extends GetView<CNMNBaocaokhaithacngayViewModel> {
  const CNMNBaocaokhaithacngay({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Báo cáo khai thác ngày CNMN'),
        centerTitle: true,
        elevation: 0,
...
class _DateHeader extends StatelessWidget {
  ...
  final CNMNBaocaokhaithacngayViewModel vm;
