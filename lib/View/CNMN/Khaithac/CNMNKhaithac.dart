...
class CNMNKhaithac extends GetView<CNMNKhaithacViewModel> {
  const CNMNKhaithac({super.key});
        ...
        children: [
          Positioned(
            ...
            child: Stack(
              fit: StackFit.expand,
              children: [
                Image.asset('asset/images/background_header.png', fit: BoxFit.cover),
          ...
          Container(
            ...
            child: Center(
              child: Opacity(
                ...
                child: SvgPicture.asset(svg, width: 80, height: 80),
              ),
            ),
          ),
