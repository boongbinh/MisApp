...
class CNMTPhantichchiphi extends GetView<CNMTPhantichchiphiViewModel> {
  const CNMTPhantichchiphi({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Phân tích chi phí - CNMT'),
        centerTitle: true,
        elevation: 0,
...
class _DateRangeCard extends StatelessWidget {
  ...
  final CNMTPhantichchiphiViewModel vm;
...
class _FilterSheet extends StatefulWidget {
  static Future<void> open(BuildContext context, CNMTPhantichchiphiViewModel vm) async {
