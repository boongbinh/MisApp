...
class CNMTThongtinchung extends GetView<CNMTThongtinchungViewModel> {
  const CNMTThongtinchung({super.key});
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Thông tin chung - CNMT'),
          centerTitle: true,
          elevation: 0,
...
class _SearchAndFilterBar extends StatelessWidget {
  ...
  final CNMTThongtinchungViewModel vm;
...
class _FilterSheet extends StatefulWidget {
  static Future<void> open(BuildContext context, CNMTThongtinchungViewModel vm) async {
