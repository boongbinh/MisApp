...
class CNMTBaocaokhaithacngay extends GetView<CNMTBaocaokhaithacngayViewModel> {
  const CNMTBaocaokhaithacngay({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Báo cáo khai thác ngày CNMT'),
        centerTitle: true,
        elevation: 0,
                ...
                children: [
                  ...
                  Obx(() {
                    ...
                    return SanluongtuansanbayChart(
                      ...
                      title: 'Sân bay Đà Nẵng-Sản lượng tuần',
                      height: 300,
                    );
                  }),
                  const SizedBox(height: 16),
...
class _DateHeader extends StatelessWidget {
  ...
  final CNMTBaocaokhaithacngayViewModel vm;
