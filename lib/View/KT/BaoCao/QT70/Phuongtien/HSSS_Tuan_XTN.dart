...
class HSSS_Tuan_XTN extends GetView<HSSS_Tuan_XTNViewModel> {
  const HSSS_Tuan_XTN({super.key});
                                        ...
                                        return Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              _BodyCell(controller.formatNumber((item['HSSS'] as num?)?.toDouble() ?? 0), flex: 0.8),
                                            ],
                                          ),
                                        );
                                      }),
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            _BodyCell(
                                              controller.formatNumber(totals['HSSS']),
                                              flex: 0.8,
                                              fontWeight: FontWeight.bold,
                                            ),
                                          ],
...
class _SearchAndFilterBar extends StatelessWidget {
  ...
  final HSSS_Tuan_XTNViewModel vm;
...
class _FilterSheet extends StatefulWidget {
  static Future<void> open(BuildContext context, HSSS_Tuan_XTNViewModel vm) async {
