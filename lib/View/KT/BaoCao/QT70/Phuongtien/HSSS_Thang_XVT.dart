...
class HSSS_Thang_XVT extends GetView<HSSS_Thang_XVTViewModel> {
  const HSSS_Thang_XVT({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('HSSS xe vận CNVT (tháng)'),
        centerTitle: true,
        elevation: 0,
...
class _SearchAndFilterBar extends StatelessWidget {
  ...
  final HSSS_Thang_XVTViewModel vm;
...
class _FilterSheet extends StatefulWidget {
  static Future<void> open(BuildContext context, HSSS_Thang_XVTViewModel vm) async {
