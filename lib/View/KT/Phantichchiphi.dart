...
class Phantichchiphi extends GetView<PhantichchiphiViewModel> {
  const Phantichchiphi({super.key});
              ...
              return SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    // Secondary Metric Grid (2 cards)
                    _SecondaryMetricGrid(vm: controller),
                    const SizedBox(height: 16),

                    // Vehicle Category Grid (2 cards)
                    _VehicleCategoryGrid(vm: controller),
                    const SizedBox(height: 16),
                    // ====== Card Chi phí tra nạp ======
                    Obx(() {
                      ...
                      return ChiphitranapCard(
                        dataList: dataList,
                        title: 'CHI PHÍ XE TRA NẠP',
                      );
                    }),
                    // ====== Card Chi phí xe vận tải ======
                    const SizedBox(height: 16),
                    Obx(() {
                      ...
                      return BangchiphitranapCard(
                        ...
                        title: 'TỔNG HỢP CHI PHÍ XE TRA NẠP',
                      );
                    }),
                    const SizedBox(height: 16),
                    ...
                    Obx(() {
                      ...
                      return BangchiphixevantaiCard(
                        ...
                        title: 'TỔNG HỢP CHI PHÍ XE VẬN TẢI',
                      );
                    }),
                    const SizedBox(height: 16),
                    Obx(() {
                      ...
                      return BangchiphikhacCard(
                        ...
                        title: 'TỔNG HỢP CHI PHÍ KHO BỂ',
                        type: 'kho_be',
                      );
                    }),
                    const SizedBox(height: 16),

                    // ====== Card Bảng chi phí hàng hiểm ======
                    Obx(() {
                      ...
                      return BangchiphikhacCard(
                        ...
                        title: 'TỔNG HỢP CHI PHÍ HÓA NGHIỆM',
                        type: 'hang_hiem',
                      );
                    }),
                    const SizedBox(height: 16),
...
class _SearchAndFilterBar extends StatelessWidget {
  ...
  final PhantichchiphiViewModel vm;
...
class _FilterSheet extends StatefulWidget {
  static Future<void> open(BuildContext context, PhantichchiphiViewModel vm) async {
      ...
      children: [
        Expanded(
          child: _MetricCard(
            ...
            unit: 'VND',
            label: 'Tổng chi phí /giờ hoạt động',
        ...
        Expanded(
          child: _MetricCard(
            ...
            unit: 'VND',
            label: 'Tổng chi phí /km hoạt động',
            color: const Color(0xFF006C49),
            backgroundColor: const Color(0xFFF0FDF4),
            borderColor: const Color(0xFFDCFCE7),
          ),
...
class _VehicleCategoryGrid extends StatelessWidget {
  const _VehicleCategoryGrid({required this.vm});
  final PhantichchiphiViewModel vm;
      ...
      children: [
        Expanded(
          child: _MetricCard(
            ...
            iconColor: const Color(0xFFBC0B3B),
            value: vm.formatNumber(vm.tongCPXeTN.value),
            unit: 'VND',
            label: 'Tổng chi phí /xe tra nạp',
            color: const Color(0xFFBC0B3B),
        ...
        Expanded(
          child: _MetricCard(
            ...
            iconColor: const Color(0xFFBC0B3B),
            value: vm.formatNumber(vm.tongCPXeVC.value),
            unit: 'VND',
            label: 'Tổng chi phí /xe vận chuyển',
            color: const Color(0xFFBC0B3B),
            backgroundColor: const Color(0xFFFFF1F2),
            borderColor: const Color(0xFFFFE4E6),
          ),
