...
List<_ColDef> _buildColDefs(MaybomDetailViewModel vm) {
  return [
...
class MaybomDetail extends GetView<MaybomDetailViewModel> {
  const MaybomDetail({super.key});
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          GetBuilder<MaybomDetailViewModel>(
                            id: 'header',
