...
List<_ColDef> _buildColDefs(XeVanchuyenDetailViewModel vm) {
  return [
...
class XeVanchuyenDetail extends GetView<XeVanchuyenDetailViewModel> {
  const XeVanchuyenDetail({super.key});
