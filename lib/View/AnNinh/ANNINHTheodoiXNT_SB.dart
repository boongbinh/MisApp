// views/anninh_theodoi_xnt_sb_view.dart
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:intl/intl.dart';
import 'package:skypec/Controller/AnNinh/ANNINHTheodoiXNT_SBViewModel.dart';
import 'package:skypec/Components/AnNinh/TheodoiXNT_SBCard.dart';

class ANNINHTheodoiXNT_SB extends GetView<ANNINHTheodoiXNT_SBViewModel> {
  const ANNINHTheodoiXNT_SB({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Theo dõi XNT kho cảng - Theo sân bay'),
        centerTitle: true,
        elevation: 0,
          ...
          SafeArea(
            child: Obx(() {
              ...
              return ListView(
                ...
                children: [
                  // ⭐ Filter bar chỉ có 1 dòng + nút filter
                  _FilterBar(vm: controller),
                  const SizedBox(height: 12),

                  // Bảng dữ liệu
                  Obx(() {
                    if (controller.theodoiXNTkhoCang_SB.isEmpty) {
                      return Container(
                        height: 200,
                    ...
                    return TheodoiXNT_SBCard(
                      data: controller.theodoiXNTkhoCang_SB.toList(),
                      title:
                          'THEO DÕI XNT KHO CẢNG THEO SÂN BAY - ${controller.displayDate}',
                    );
                  }),
...
class _FilterBar extends StatelessWidget {
  ...
  final ANNINHTheodoiXNT_SBViewModel vm;
...
class _FilterSheet extends StatefulWidget {
  static Future<void> open(
      BuildContext context, ANNINHTheodoiXNT_SBViewModel vm) async {
      ...
      children: [
        ...
        InkWell(
          onTap: () => _showSingleSelectSheet(
              context, label, options, selected.value, onChanged),
          child: Container(
            height: 44,
            padding: const EdgeInsets.symmetric(horizontal: 12),
            decoration: BoxDecoration(
